...
if [ "$#" -eq 0 ]; then
 export DATA_DIRECTORY=/Users/mac/Desktop/PFE_Asma/tiramisu/utils/code_generator-unrolling/cmake-build-debug/samples/
 echo " Default <DATA_DIRECTORY> :=/Users/mac/Desktop/PFE_Asma/tiramisu/utils/code_generator-unrolling/cmake-build-debug/samples/"
else
 DATA_DIRECTORY=/Users/mac/Desktop/PFE_Asma/tiramisu/utils/code_generator-unrolling/cmake-build-debug/samples"$1"/
    Code_FROM="$1" 
fi
