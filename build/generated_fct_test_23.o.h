#ifndef HALIDE__build___generated_fct_test_23_o_h
#define HALIDE__build___generated_fct_test_23_o_h
#include <stdint.h>
...
int tiramisu_generated_code(struct halide_buffer_t *_buf0_buffer, struct halide_buffer_t *_buf1_buffer, struct halide_buffer_t *_buf2_buffer, struct halide_buffer_t *_buf3_buffer, struct halide_buffer_t *_buf4_buffer) HALIDE_FUNCTION_ATTRS;
int tiramisu_generated_code_old_buffer_t(struct buffer_t *_buf0, struct buffer_t *_buf1, struct buffer_t *_buf2, struct buffer_t *_buf3, struct buffer_t *_buf4) HALIDE_FUNCTION_ATTRS;
